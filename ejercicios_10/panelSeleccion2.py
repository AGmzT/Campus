...
class selector(tk.Tk):
    ...
    def aceptar(self):   
        ...
        def limpiar():
            ...
            #limpia la seleccion
            seleccion.set(None)
        #define y configura una etiqueta
        bienvenidaEt = ttk.Label(self, text= 'Selecciona una de las\n siguientes opciones')
        bienvenidaEt.grid(column= 0, row= 0, padx= 5, pady= 5)
        ...
        sel1.grid(column= 0, row= 1, padx= 5, pady= 5)
        sel2.grid(column= 0, row= 2, padx= 5, pady= 5)
        sel3.grid(column= 0, row= 3, padx= 5, pady= 5)
